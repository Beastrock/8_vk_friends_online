...
There are two ways of getting online friends by VK API. The first way is to call get.friends.getOnline() for **getting online friends IDs** and then pass it to get.users() method which give us info from user ID arguments.    
